...
PROJECT_URL = "https://fapjmaafyhejjsprqhdp.supabase.co"              # URL project Supabase kamu
TABLE = "mahasiswa"                                          # nama tabel di database
SUPABASE_URL = f"{PROJECT_URL}/rest/v1/{TABLE}"               # endpoint REST Supabase

API_KEY = "sb_publishable_4DyMYzyGaCOdsP-Poy9O3Q_8uisEZ9C"                             # gunakan publishable / anon key
